...
function nameTest() {
  ...
  for (let i = 0; i < hobbyList.length; i++) {
    ...
    // input요소.checked = flase; -> 해당 요소를 체크 해제하겠다.
  ...
  document.getElementById("name-div").innerHTML
    ...
    // 요소.innerHTML
    // HTML 태그를 포함하여 문자열 들을 실제 HTML 요소로 해석함
...
function cssTest() {
  ...
  div1 = document.querySelector("[target-div='css-div'] > div");
...
function readValue() {
  ...
  // bg.scrollTop : 
  // 현재 스크롤 위치(스크롤이 현재 얼마만큼 내려와있는지 나타냄)
...
// keydown : 키가 눌러졌을 때 (+ 꾹 누르고 잇으면 계속 인식됨)
